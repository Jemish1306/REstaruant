...
const PercalPaymentBillModal = ({ isOpen, onClose, orderId }) => {
    ...
    const fetchOrderDetails = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`http://localhost:3229/api/parcelpayment/${orderId}`);
                ...
                {loading ? (
                    ...
                    <div className='text-lg'>
                        ...
                        <div className="font-bold text-right">
                            <p>Total Amount: {orderDetails.totalBill}</p>
...
PercalPaymentBillModal.propTypes = {
    isOpen: PropTypes.bool.isRequired,
    onClose: PropTypes.func.isRequired,
    id: PropTypes.string
};

export default PercalPaymentBillModal;
